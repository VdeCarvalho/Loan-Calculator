...
const smoothNote=()=>state.target==='amount'?t('flexibleAmounts'):NOTES[state.lang][1]+' '+t('adaptedTerms');
...
function pdfReport(){
  ...
  if(r.adaptedTerms)summary.unshift([t('duration'),durationText(r.months,'months')]);
